...
public class MessageClientRestProxy extends EmailClientRestProxy implements MessagesEmailClient {

    public MessageClientRestProxy(URI serverUrl, int maxRetries, int retryPeriod) {
    ...
    public EmailResponse<Void> setupUserInfo(String user, String secret) {
        ...
        return tryMultiple(() -> {
            ...
            System.out.println("CHEGUEI AQUI TAMBEM");
